...
enum layers { BASE, MBO, MEDR, NAVR, MOUR, NSSL, NSL,  GAME, GAM2, WASD, FUNL };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FUNL] = LAYOUT_miryoku(
    ...
    KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS, TG(WASD),   KC_NA,   KC_NA,   KC_ALGR, TG(GAME),
  ...
  [GAME] = LAYOUT_split_3x5_3(
    ...
    KC_LSFT,  KC_Q,     KC_J,     KC_K,   KC_X  ,   KC_B,   KC_M,    KC_W,    KC_V,   KC_Z, 
                MO(GAM2),   KC_SPC, KC_S, KC_ENT, KC_BSPC, LT(FUNL, KC_DEL)
  ),
  [GAM2] = LAYOUT_split_3x5_3(
    KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS, 
    KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,  
    KC_TRNS,  KC_TRNS,     KC_TRNS,     KC_LALT,   KC_TRNS  ,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS, 
                KC_TRNS,   KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS, LT(FUNL, KC_DEL)
  ),
  [WASD] = LAYOUT_split_3x5_3(
    KC_1,  KC_Q,  KC_W,   KC_E,   KC_R,   KC_T,   KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS, 
    ...
    KC_LCTL,  KC_Z,     KC_X,     KC_C,   KC_V  ,   KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS, 
                KC_G,   KC_SPC, KC_L, KC_TRNS, KC_TRNS, LT(FUNL, KC_DEL)
  )
